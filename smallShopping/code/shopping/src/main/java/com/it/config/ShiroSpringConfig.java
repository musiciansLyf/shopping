...
public class ShiroSpringConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager) {
        ...
        //注册界面
        filterChainDefinitionMap.put("/reg.do", "anon");
        //登录界面
        ...
        filterChainDefinitionMap.put("/home/video.do", "anon");
        filterChainDefinitionMap.put("/video/videoAjax.do", "anon");
        filterChainDefinitionMap.put("/video/videoAjax.do", "anon");
        filterChainDefinitionMap.put("/home/detail.do", "anon");
