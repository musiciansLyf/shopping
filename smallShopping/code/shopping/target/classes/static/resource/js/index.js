...
layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
    ...
    $("#fullscreen").click(function () {
        if ($(this).parent().find("i").hasClass("layui-icon-chart-screen")) {
            $(this).parent().find("i").removeClass("layui-icon-chart-screen");
            $(this).parent().find("i").addClass("layui-icon-layer");
            $(this).text("退出全屏");
        ...
        } else if ($(this).parent().find("i").hasClass("layui-icon-layer")) {
            $(this).parent().find("i").removeClass("layui-icon-layer");
            $(this).parent().find("i").addClass("layui-icon-chart-screen");
            $(this).text("全屏");
